...
export const MANDI_FAQS: MandiFAQ[] = [
  ...
  },
  {
    ...
    answer: 'Bharat Mandi aggregates all arrival lots between the 1st-15th and 16th-end of every month. Merchants can generate consolidated Form C Settlement Statements, apply deductions, review advance adjustments, and issue instant payouts via Cash, UPI, or Bank NEFT with automated PDF receipts.',
    answerTe: 'ప్రతి నెల 1-15 మరియు 16-ఆఖరు తేదీల మధ్య వచ్చిన అన్ని లాట్లను భారత్ మండి సమగ్రపరుస్తుంది. వ్యాపారులు 15 రోజుల సెటిల్‌మెంట్ స్టేట్‌మెంట్‌ను రూపొందించి UPI/నగదు/బ్యాంక్ ద్వారా చెల్లించవచ్చు.',
    answerHi: 'भारत मंडी हर महीने की 1-15 और 16-अंतिम तारीख के बीच सभी लॉट को जोड़ता है। व्यापारी समेकित फॉर्म सी निपटान विवरण बना सकते हैं और नकद/यूपीआई/बैंक के माध्यम से भुगतान कर सकते हैं।',
    tag: 'Settlement',
  },
  {
    id: 'faq-3',
  ...
  },
  {
    ...
    answer: 'Yes, 100%! Bharat Mandi uses local browser persistence and IndexedDB caches. You can record lots, calculate rates, issue parchis, and view farmer khatas without an active internet connection. All records sync automatically once reconnected.',
    answerTe: 'అవును, ఖచ్చితంగా! భారత్ మండి ఆఫ్‌లైన్-ఫస్ట్ టెక్నాలజీని ఉపయోగిస్తుంది. ఇంటర్నెట్ లేకపోయినా మీరు లాట్లను నమోదు చేయవచ్చు, రశీదులు ముద్రించవచ్చు మరియు ఖాతాలను చూడవచ్చు.',
    answerHi: 'हाँ, बिल्कुल! भारत मंडी ऑफ़लाइन-प्रथम तकनीक का उपयोग करता है। आप इंटरनेट के बिना भी लॉट दर्ज कर सकते हैं, पर्चियां निकाल सकते हैं और खाता देख सकते हैं।',
    tag: 'Offline',
  },
  {
    id: 'faq-5',
...
export const INITIAL_STOCKS: StockItem[] = [
  {
    ...
    packageType: 'Bags',
    avgCostPrice: 2450,
    targetSellingPrice: 2680,
    minReorderLevel: 100,
    storageLocation: 'Godown #1 - North Bay',
    lastUpdated: '2026-09-22',
  },
  {
    id: 'STK-002',
    name: 'Basmati Paddy (धान / चावल)',
    category: 'grains',
    quantityOnHand: 320,
    unit: 'Quintals',
    packagesCount: 640,
    packageType: 'Bags',
    avgCostPrice: 3800,
    targetSellingPrice: 4200,
    minReorderLevel: 80,
    storageLocation: 'Godown #2 - East Shed',
    lastUpdated: '2026-09-22',
  },
  {
    id: 'STK-003',
    ...
    packageType: 'Bags',
    avgCostPrice: 1950,
    targetSellingPrice: 2350,
    minReorderLevel: 50,
    storageLocation: 'Vegetable Yard Bay A',
    lastUpdated: '2026-09-22',
  },
  {
    id: 'STK-004',
    ...
    packageType: 'Crates',
    avgCostPrice: 450,
    targetSellingPrice: 620,
    minReorderLevel: 30,
    storageLocation: 'Cold Store Shed #4',
    lastUpdated: '2026-09-22',
  },
  {
    id: 'STK-005',
    name: 'Dutch Rose (डच गुलाब)',
    category: 'flowers',
    quantityOnHand: 250,
    unit: 'Bunches',
    packagesCount: 50,
    ...
    minReorderLevel: 40,
    storageLocation: 'Flower Auction Hall Shed 2',
    lastUpdated: '2026-09-22',
  },
  {
    id: 'STK-006',
    name: 'Yellow Marigold (गेंदा फूल)',
    category: 'flowers',
    quantityOnHand: 600,
    unit: 'Kgs',
    packagesCount: 30,
    ...
    minReorderLevel: 100,
    storageLocation: 'Flower Auction Hall Bay 1',
    lastUpdated: '2026-09-22',
  },
];
...
export const INITIAL_EMPLOYEES: EmployeeRecord[] = [
  {
    ...
    phone: '9845112233',
    role: 'Accountant',
    dailyWageOrSalary: 28000,
    wageType: 'monthly',
    status: 'active',
    joinedDate: '2025-01-15',
    totalPaid: 196000,
    balanceDue: 0,
    notes: 'Handles Form C, ledger balance, and banking transactions',
  },
  {
    id: 'EMP-002',
    ...
    phone: '9845223344',
    role: 'Weighman (Taula)',
    dailyWageOrSalary: 750,
    wageType: 'daily',
    status: 'active',
    joinedDate: '2025-03-01',
    totalPaid: 45000,
    balanceDue: 1500,
    notes: 'Chief Weighman on Electronic Scale #1 (Certified by Mandi Samiti)',
  },
  {
    id: 'EMP-003',
    name: 'Suresh Kumar Coolie',
    phone: '9845334455',
    role: 'Hamal / Coolie',
    dailyWageOrSalary: 650,
    wageType: 'daily',
    status: 'active',
    joinedDate: '2025-02-10',
    totalPaid: 39000,
    balanceDue: 650,
    notes: 'Hamali & unloading team leader (Bay 1 & 2)',
  },
  {
    id: 'EMP-004',
    name: 'Raju Bhai Prajapati',
    phone: '9845445566',
    role: 'Supervisor',
    dailyWageOrSalary: 22000,
    wageType: 'monthly',
    status: 'active',
    joinedDate: '2025-04-01',
    totalPaid: 110000,
    balanceDue: 0,
    notes: 'Godown and stock management supervisor',
  },
  {
    id: 'EMP-005',
    ...
    phone: '9845556677',
    role: 'Clerk',
    dailyWageOrSalary: 600,
    wageType: 'daily',
    status: 'active',
    joinedDate: '2025-06-15',
    totalPaid: 24000,
    balanceDue: 1200,
    notes: 'Gate entry, token issue, and farmer registration',
  },
];
